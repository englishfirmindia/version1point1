...
final String apiKey = "AIzaSyAUXQQU3pYLkq7X5x5qSC0VlFIIRvxMYV0"; // Replace with your Gemini API key
...
return Scaffold(
appBar: AppBar(
title: Text('Englishfirm AI Assistant', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
...
items: _languageLocales.entries.map<DropdownMenuItem<String>>((entry) {
...
color: message["isUser"] ? Colors.deepPurpleAccent : Colors.grey[300],
